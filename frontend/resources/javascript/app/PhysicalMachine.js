...
define(function() {
  ...
  class PhysicalMachine {
    ...
    showSettings () {
      ...
      const domMachineTitle = document.createElement('input')
      domMachineTitle.placeholder = "Physical Machine"
      domMachineTitle.onchange = () => {
        window.el = this.dom
        this.dom.title.text = domMachineTitle.value
      }

      domPhysicalMachineOptions.append(domMachineTitle);
    }
